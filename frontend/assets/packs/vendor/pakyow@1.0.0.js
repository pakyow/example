(function (global, factory) {
  ...
  var _default$4 = function _default(attribute, view) {
    _classCallCheck(this, _default);
  ...
  attributeClasses[attributeTypeSet] = _default$2;
  attributeClasses[attributeTypeHash] = _default$3;
  attributeClasses[attributeTypeBoolean] = _default$4;
  attributeClasses[attributeTypeDefault] = _default$5;
  ...
  function () {
    ...
    _createClass(_default, [{
      key: "get",
      value: function get(attribute) {
        return new _default$7(this.viewSet.views.map(function (view) {
    ...
    _createClass(_default, [{
      ...
      value: function find(names, options) {
        ...
        if (found.length > 0 || templates.length > 0) {
          var set = new _default$9(found, templates);
  ...
  ready(function () {
    var pwGlobal = new (_default$b.create())(new _default$a(document), {});
    pwGlobal.listen("pw:socket:connected", function () {
      _default.reachable = true;
    });
    pwGlobal.listen("pw:socket:disconnected", function () {
      _default.reachable = false;
    });
    pwGlobal.listen("pw:socket:disappeared", function () {
      _default.reachable = false;
    });
    pwGlobal.listen("pw:socket:message:transformation", function (message) {
      new _default$c(message);
    });
    _default$b.init(document.querySelector("html"));
  });
